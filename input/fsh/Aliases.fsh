...
Alias: $documentreference-composition-status = http://hl7.org/fhir/composition-status
Alias: $documentreference-status = http://hl7.org/fhir/document-reference-status
